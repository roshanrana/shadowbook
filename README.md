...
> Built to production constraints. No real money, no real data,
...
| Read this | For |
|---|---|
| **`docs/OVERVIEW.md`** | the setting and the two findings in context |
| **`docs/SHOWCASE.md`** | the feature tour: every component, with the commands and tests that show it |
